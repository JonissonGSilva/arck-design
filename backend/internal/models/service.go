...
const (
	ServiceCategoryResidencial  ServiceCategory = "Residencial"
	ServiceCategoryComercial    ServiceCategory = "Comercial"
	ServiceCategoryInteriores   ServiceCategory = "Interiores"
	ServiceCategoryReforma      ServiceCategory = "Reforma"
	ServiceCategoryConsultoria  ServiceCategory = "Consultoria"
	ServiceCategoryPaisagismo   ServiceCategory = "Paisagismo"
)
