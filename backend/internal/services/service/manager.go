...
// CreateService cria um novo serviço para o arquiteto
...
// GetPublicServicesByArchitect retorna serviços ativos de um arquiteto (visão pública)
func GetPublicServicesByArchitect(ctx context.Context, architectID string) ([]*models.Service, error) {
